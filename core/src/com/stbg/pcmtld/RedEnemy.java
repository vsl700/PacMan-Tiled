...
public class RedEnemy extends Entity {
	...
	public void create(EntitySnapshot snapshot, EntityType type, GameMap map){
		...
		walkSheet = new Texture(Gdx.files.internal("pacman/pacmanassets/pacman-monster-red-right.png"));
        ...
        //else if(left){
			walkSheet2 = new Texture(Gdx.files.internal("pacman/pacmanassets/pacman-monster-red-left.png"));
	...
	public void update(float deltaTime , float gravity){
		...
		/*if(ready){
			//int p = 0;
			//for(int i = 0; i < GameMap.entityAmount - 1; i++)
				// If the info on line i is about the current enemy, do this below!
				if(value == "red"){
					Entity.redX2[position] = pos.x;
					Entity.redY2[position] = pos.y;
				}
		}*/
		//entityCollision(0, 0, x, y);
	...
	public static void setValue(String value) {
		RedEnemy.value = value;
	}

	public static void setPosition(int position) {
		RedEnemy.position = position;
	}
