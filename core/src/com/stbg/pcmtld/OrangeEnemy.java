...
public class OrangeEnemy extends Entity {
	...
	public void create(EntitySnapshot snapshot, EntityType type, GameMap map){
		...
		walkSheet = new Texture(Gdx.files.internal("pacman/pacmanassets/pacman-monster-orange-right.png"));
        ...
        //else if(left){
			walkSheet2 = new Texture(Gdx.files.internal("pacman/pacmanassets/pacman-monster-orange-left.png"));
